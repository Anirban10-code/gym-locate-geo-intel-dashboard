...
export const DOMAIN_CONFIG: Record<DomainId, DomainConfig> = {
  ...
  bank: {
    ...
    scoring: {
      demand: { label: 'Density', desc: 'Offices + Residents', color: '#3b82f6', weight: 0.40, saturationLimit: 20 },
      ...
      infra: { label: 'Anchors', desc: 'Retail + Commercial', color: '#ec4899', weight: 0.10, saturationLimit: 12 },
    },
  },
  retail: {
    id: 'retail',
